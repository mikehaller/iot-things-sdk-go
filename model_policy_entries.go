...
package iotthings
// PolicyEntries Policy entries containing one policy entry for each arbitrary `label` key
type PolicyEntries struct {
	Label1 PolicyEntry `json:"label1,omitempty"`
	LabelN PolicyEntry `json:"labelN,omitempty"`
}
