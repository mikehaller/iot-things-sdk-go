...
// APIClient manages communication with the Bosch IoT Things HTTP API API v2
...
type APIClient struct {
	...
	ThingsSearchApi *ThingsSearchApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ThingsSearchApi = (*ThingsSearchApiService)(&c.common)
