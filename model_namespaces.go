...
package iotthings
// Namespaces List of namespaces where the key represents the `namespaceId` of each namespace. The `namespaceId` key must be unique in the list.
type Namespaces struct {
	NamespaceId1 DefaultNamespaceEntry `json:"namespaceId1,omitempty"`
}
